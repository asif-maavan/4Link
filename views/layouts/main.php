                        ...
                        <div class="navbar navbar-inverse" role="banner">
                            <nav class="collapse navbar-collapse bs-navbar-collapse navbar-right" role="navigation">
                                <ul class="nav navbar-nav">
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php if (Yii::$app->user->identity->profile_picture) { ?><img src="<?= $baseUrl ?>/uploads/<?= Yii::$app->user->identity->profile_picture //user_img.png       ?>" width="32" height="32" alt="User"/><?php } ?><?= (Yii::$app->user->identity->_id) ? Yii::$app->user->identity->first_name.' '.Yii::$app->user->identity->last_name : 'Guest' ?><b class="caret"></b></a> 
